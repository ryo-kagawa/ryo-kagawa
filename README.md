...
## 🌱 Skills
<img alt="skills" src="https://skillicons.dev/icons?theme=dark&perline=8&i=aws,bash,c,cpp,cs,css,discord,docker,dotnet,eclipse,electron,git,github,gitlab,gmail,go,gradle,html,java,js,jenkins,jest,jquery,kafka,kubernetes,linux,md,mysql,nextjs,nginx,nodejs,notion,npm,php,postgres,postman,powershell,prisma,rails,react,redhat,redis,redux,regex,ruby,sass,spring,sqlite,ts,ubuntu,unity,vercel,visualstudio,vite,vscode,webpack" />
