...
|9|2017/03|2019/07|4|証券取引システム|リニューアル|フロント側を作成|プログラマー|フロントエンド<ul><li>HTML（Reactで生成）</li><li>CSS</li><li>JavaScript</li><li>React</li><li>jQuery</li></ul>|一部機能を担当|
|10||2019/07|4|証券取引システム|リニューアル|フロント側を作成|プログラマー|フロントエンド<ul><li>HTML（Reactで生成）</li><li>Sass（SCSS）</li><li>JavaScript</li><li>React</li><li>jQuery</li><li>bignumber.js</li></ul>|全機能を最終的に担当|
